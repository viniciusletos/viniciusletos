...
- 🌱 Atualmente aprimorando minhas habilidades em **Java/Spring** (Backend) e **Node.js/React** (Frontend).
- 🚀 Tenho um forte interesse em desenvolvimento **Backend** e **Frontend**, APIs RESTful e arquiteturas de software eficientes.
